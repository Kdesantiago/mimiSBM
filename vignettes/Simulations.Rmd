...
What's more, here we can still recognize these structures because the observations have been ordered according to their clusters. If we replace the parameter with `FALSE`, we'll not be able to recognize the structure easily.
